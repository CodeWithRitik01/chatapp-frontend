...
import {Menu as MenuIcon, KeyboardBackspace as KeyboardBackspaceIcon, Group, Edit as EditIcon, Done as DoneIcon, Update, Delete as DeleteIcon, Add as AddIcon} from '@mui/icons-material'
...
import { miscSelector, setIsAddMember } from '../redux/reducer/misc'
...
const Groups = () => {
  ...
  const {isAddMember} = useSelector(miscSelector);
